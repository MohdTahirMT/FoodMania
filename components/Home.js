...
export default Home = ({navigation}) => {
  ...
  const [selectedBurger, setSelectedBurger] = useState(true);
  const [selectedDrinks, setSelectedDrinks] = useState(true);
    ...
    return (
      <View
        style={[
          ...
          {
            backgroundColor: item.title == selected ? colors.primary : colors.white,
        ...
        <View
          style={[
            ...
            {
              backgroundColor: item.title == selected ? colors.white : colors.secondary,
            },
          ]}>
          <Feather
            onPress={() => {
            ...
            color={item.title == selected ? colors.black : colors.white}
          />
        </View>
      </View>
    );
